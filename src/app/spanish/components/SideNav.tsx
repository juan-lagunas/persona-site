            ...
            <div className="flex overflow-auto h-full">
                <div className="grid grid-rows-3 w-[22.5%] max-w-[200px] h-full py-10 bg-[#0D0D0D]">
                    ...
                    <div className="flex flex-col gap-y-6 items-center justify-center capitalize">
                        <a href="#journey">Misión</a>
                        <a href="#empower">Acción</a>
                        <a href="#connect">Unir</a>
                    </div>
                    <div className="flex flex-col items-center justify-end gap-y-4">
                        ...
                        <Link href="/english" className="md:bg-[#B3A369] md:text-[#0D0D0D] md:py-2 md:px-4 md:rounded-3xl md:opacity-90 md:hover:opacity-100 md:transition md:ease-in-out">English</Link>
                    </div>
                </div>
