            ...
            <div className="flex overflow-auto h-full">
                <div className="grid grid-rows-3 w-[20%] max-w-[200px] h-full py-10 bg-[#0D0D0D]">
                    ...
                    <div className="flex flex-col gap-y-6 items-center justify-center capitalize">
                        <a href="#journey">Propósito</a>
                        <a href="#empower">Empoderamiento</a>
                        <a href="#connect">Ayuda</a>
                    </div>
                    <div className="flex flex-col items-center justify-end gap-y-4">
                        ...
                        <Link href="/english" className="bg-[#B3A369] text-[#0D0D0D] py-2 px-4 rounded-3xl opacity-90 hover:opacity-100 transition ease-in-out">English</Link>
                    </div>
                </div>
